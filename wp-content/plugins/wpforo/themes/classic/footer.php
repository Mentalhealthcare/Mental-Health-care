            ...
            <div class="wpforo-stat-table">
                ...
                <div class="wpf-row wpf-last-info">
                    <p class="wpf-stat-other">
						...
						<?php if( isset( $stat['posts'] ) && $stat['posts'] ): ?><span class="wpf-stat-recent-posts"><i class="fas fa-list-ul"></i> <a href="<?php echo esc_url( wpforo_home_url( wpforo_settings_get_slug( 'recent' ) ) ) ?>"><?php wpforo_phrase( 'Recent Posts' ) ?></a></span><?php endif; ?>
						<?php if( isset( $stat['posts'] ) && $stat['posts'] ): ?><span class="wpf-stat-unread-posts"><i class="fas fa-layer-group"></i> <a href="<?php echo esc_url( wpforo_home_url( wpforo_settings_get_slug( 'recent' ) . '?view=unread' ) ) ?>"><?php wpforo_phrase( 'Unread Posts' ) ?></a></span><?php endif; ?>
						<?php if( wpforo_is_module_enabled( 'tags' ) ): ?><span class="wpf-stat-tags"><i class="fas fa-tag"></i> <a href="<?php echo esc_url( wpforo_home_url( wpforo_settings_get_slug( 'tags' ) ) ) ?>"><?php wpforo_phrase( 'Tags' ) ?></a></span><?php endif; ?>
                    </p>
